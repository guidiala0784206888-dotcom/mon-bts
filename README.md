...
- **Figures manipulables** — champ tournant, vecteur de Fresnel, couplages,
  courant de défaut, circuit à auto-maintien… On les met en pause, on les règle,
  certaines se cliquent ou se font glisser.
...
La progression est enregistrée dans le navigateur, et exportable depuis le
carnet de notes.
